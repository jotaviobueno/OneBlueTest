...
class UpdateController {
    ...
    async ChangePasswordV1 ( req, res ) {
        ...
        if ( await repository.updatePassword( new_password, UserInfo.email )) {
            ...
            await repository.createLogUpdatePassword( UserInfo.email );
    ...
    async changeEmail ( req, res ) {
        ...
        const tokenInfo = await UserHelper.existEmailToken( change_token );
        ...
        if ( await repository.ChangeEmail( UserInfo.email, new_email )) {
            ...
            await repository.deleteEmailToken( change_token );
    ...
    async changePasswordV2 ( req, res ) {
        ...
        const tokenInfo = await AuthHelper.existPasswordToken( change_token );
        ...
        if ( await repository.updatePassword( new_password, UserInfo.email )) {
            ...
            await repository.deletePasswordToken( change_token );
